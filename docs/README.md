this directory is just called docs so that github will host it on github pages.
There is no real documentation, but as a supliment here you have a compliment (or
whatever this is that `fortune -l` gave me).
